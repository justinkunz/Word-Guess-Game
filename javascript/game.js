        ...
        function startGame(cat){
            ...
            //Call changeImg function, sets the hangman image to empty hangman set (6 remaining wrong guesses)
            changeImg(6)
            
            //Declare Initial remaining wrong guesses
            gLeft.textContent = 6;
            ...
            function draw(){
                ...
                for(i=0;i<computerChoice.length; i++){
                    ...
                    //Else add "_ " to outline, +1 to wordCount
                    else {    
            ...
            document.onkeyup = function(e){
                ...
                //if key has already been pressed, stop executing function
                if(keyPushed == true){
                    return
                }

                //if key pressed is not a letter, stop executing function
